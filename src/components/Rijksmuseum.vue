	...
	<section class="rijksmuseum"> 
		<div class="visit">
			...
			<div class="visit-info"> 
				...
				<h1 class="ani-title">Rijksmuseum </h1>
				<h2 class="ani-subtitle">Museum</h2>
			...
			<div class="routings">
				...
				<div class="ani-map planner-map__base planner-map2">
					...
					<g id="Layer_1_1_">
							...
							<linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="276.5" y1="991" x2="5.5" y2="991" gradientTransform="matrix(1 0 0 1 0 -958)">
						...
						<circle fill="#304FFE" stroke="#FFFFFF" stroke-miterlimit="10" cx="275.2" cy="49.7" r="6.4"/>
					</g>
					</svg>
				...
				<div class="specs__wrap">
					<div class="routeby">Route made possible by Amsterdam local: J. Frielink</div>
					<div class="specs">Rating: 95% 👍</div>
					<div class="specs">Distance: 1.5km</div>
				</div>
				<p class="ani-info">The Rijksmuseum is the museum of the Netherlands. The completely renovated Rijksmuseum tells the story of the Netherlands from the Middle Ages to the 20th century. Including works by Rembrandt, Vermeer, Frans Hals, and more! Most famous is Rembrandt's masterpiece the Night Watch. A new display of the collection, a renewed building, new public facilities, a revamped garden and a new Asian Pavilion. Open daily from 9 am to 5 pm.</p>
			</div>
		</div>
    </section>
</template>
