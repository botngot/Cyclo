<template>
	<section class="safe"> 
		<div class="navigate navigate__1">
			<img src="../assets/nav/links.svg" alt="" class="rechtsaf">
			...
			<img src="../assets/nav/linksaf.png" alt="" class="nav__signal">
			<div id="message"></div>
			<div class="placeof">A place of interest is nearby</div>
			<router-link to="/navigatingleft">
...
<script>
	...
	export default {
		...
		mounted() { 
			  ...
			  var nav1 = document.querySelector('.placeof');
			  ...
			  function countdown() {
			    ...
			    if (seconds === 485) { 
			      var nav1 = document.querySelector('.placeof');
			      nav1.classList.add('placeofshow');
			    } 
			    if (seconds === 470) { 
			   	  var volgende = document.querySelector('.volgende');
