	...
	<section class="rijksmuseum"> 
		<div class="visit">
			...
			<div class="visit-info"> 
				...
				<h1 class="ani-title">Van Gogh Museum</h1>
			...
			<div class="routings">
				...
				<div class="specs__wrap">
					...
					<div class="specs">Rating: 92% 👍</div>
					<div class="specs">Distance: 1.9km</div>
				</div>
				<p class="ani-info">The Van Gogh Museum is an art museum dedicated to the works of Vincent van Gogh and his contemporaries in Amsterdam in the Netherlands.</p>
			</div>
		</div>
    </section>
</template>
...
<style lang="scss" scoped> 
	...
	.rijkcell2 {
		background-image: url('../assets/vangogh2.jpg');
	}

	.rijkcell3 {
		background-image: url('../assets/vangogh3.jpg');
	}
